                            ...
                            <form action="userRegister" method="post">
                                <div class="col-md-4 col-lg-4 col-lg-offset-4 col-md-offset-4 col-center-block" style="background-color: white; opacity: 0.6; padding: 25px; border-radius: 10px;margin: 0 auto;">
                                    ...
                                    <div class="form-group" style="margin: 0 auto">
                                        ...
                                        <input type="password" name="rpassword" class="form-control" placeholder="Confirm Password" aria-describedby="sizing-addon3">
                                    </div>
                                    <div class="form-group" style="margin: 0 auto; margin-top: 10px">
                                        <label>Sex</label>
                                        <label class="custom-radio"><input type="radio" name="sex" value="1">男</label>
                                        <label class="custom-radio"><input type="radio" name="sex" value="0">女</label>
                                    </div>
