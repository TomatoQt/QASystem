                ...
                <form action="addSuggestion.do" method="post" class="was-validated">
                    <div class="mb-3">
                        ...
                        <div class="input-group is-invalid">
                            <input type="text" class="form-control is-invalid" name="teaS_title" placeholder="请输入提议的标题" aria-describedby="validatedInputGroupPrepend" required>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control is-invalid" rows="10" name="teaS_content" id="validationTextarea" placeholder="请详细地描述提议内容" required></textarea>
                        <div class="valid-feedback">
                            提议内容有效
                        </div>
                    </div>
