...
public class teaSuggestion {
    ...
    private String teaS_time;

    public teaSuggestion() {}

    public teaSuggestion(String teaS_id, String tea_id, String teaS_title, String teaS_content, String teaS_time) {
    ...
    public String getTeaS_time() {
        return teaS_time;
    }

    public void setTeaS_time(String teaS_time) {
        this.teaS_time = teaS_time;
    }
}
